...
const tutorialSteps = [
  ...
  {
    title: 'Bước 1: Thiết lập API Key (Quan trọng!)',
    content: 'Trước hết, hãy thiết lập khóa API của bạn. Nhấp vào biểu tượng bánh răng ⚙️ ở góc trên bên phải để nhập khóa API Google Gemini của bạn. Đây là bước cần thiết để ứng dụng hoạt động.',
  },
  {
